  ...
  return (
    <div className="rounded-xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 overflow-hidden shadow-panel">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-stone-100 dark:border-stone-800 bg-stone-50 dark:bg-stone-950">
        ...
        <span className="ml-auto flex items-center gap-1.5 text-xs font-medium text-teal-600 dark:text-teal-400">
      ...
      {[
        ...
        >
          ...
          <span className="text-xs font-mono text-teal-500 dark:text-teal-400 flex-shrink-0">{conf}%</span>
        </div>
      ))}
      ...
      <div className="px-5 py-3 bg-stone-50/60 dark:bg-stone-950/60 flex items-center justify-between">
        ...
        <span className="text-xs font-medium text-teal-600 dark:text-teal-400">93% avg confidence</span>
      </div>
    </div>
  );
}
        ...
        <div className="rounded-xl border border-stone-200 dark:border-stone-800 overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-5 py-2.5 border-b border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-950">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold text-teal-600 dark:text-teal-400">Ready to run</span>
            </div>
          </div>
                  ...
                  <div key={node.id} className="flex items-center">
                    ...
                    <div
                      className={[
                        ...
                        node.active
                          ? "border-teal-300 dark:border-teal-700 bg-white dark:bg-stone-900 shadow-sm ring-2 ring-teal-200/60 dark:ring-teal-800/40"
                    ...
                    >
                      ...
                      {node.active && (
                        <span className="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-teal-500 flex items-center justify-center shadow-sm">
          ...
          <div className="border-t-2 border-teal-200 dark:border-teal-800">

            {/* Panel header */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-stone-100 dark:border-stone-800 bg-teal-50/40 dark:bg-teal-950/20">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-xs border border-teal-200 dark:border-teal-800 bg-teal-50 dark:bg-teal-950 flex items-center justify-center">
                  <svg className="w-3 h-3 text-teal-600 dark:text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {COLUMN_FIELDS.map(({ name, type, req, checked, conf }) => (
              ...
              >
                ...
                >
                  {checked && (
                    <svg className="w-2.5 h-2.5 text-teal-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                  )}
                </div>
                ...
                {/* Required */}
                <span className={["text-xs font-medium", req ? "text-teal-600 dark:text-teal-400" : "text-stone-300 dark:text-stone-600"].join(" ")}>
                  {req ? "yes" : "—"}
                </span>
                {/* Confidence */}
                <span className="text-[11px] font-mono text-teal-500 dark:text-teal-400 text-right">{conf}%</span>
              </div>
            ))}
            ...
            <div className="flex items-center justify-between px-5 py-3 bg-stone-50 dark:bg-stone-950 border-t border-stone-100 dark:border-stone-800">
              ...
              <button
                type="button"
                className="text-[12px] font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 flex items-center gap-1 transition-colors"
              >
                Save as template →
              </button>
            </div>
    ...
    <section id="modes" className="py-24 lg:py-32 bg-stone-50 dark:bg-stone-950">
      <div className="mkt-section">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div key={node} className="flex items-center gap-1">
                    <span
                      className={[
                        ...
                        node === "Col. Config"
                          ? "border border-teal-300 dark:border-teal-700 bg-teal-50 dark:bg-teal-950/50 text-teal-700 dark:text-teal-300"
          ...
          <div className="rounded-xl border border-teal-200 dark:border-teal-900 bg-white dark:bg-stone-900 overflow-hidden">
            <div className="border-b border-teal-100 dark:border-teal-900/60 bg-teal-50/50 dark:bg-teal-950/30 px-8 py-6">
              <span className="inline-flex items-center gap-2 text-[10px] font-semibold tracking-[0.12em] uppercase text-teal-700 dark:text-teal-400 mb-4">
                <span className="w-1.5 h-1.5 rounded-full bg-teal-500" />
                Recruiter Mode
              </span>
              <h3
            ...
            <div className="px-8 py-5 border-b border-stone-100 dark:border-stone-800">
              ...
              <div className="flex items-center gap-1 flex-wrap">
                {["Source", "Transcript", "Extraction", "JD Analysis", "Profile", "Review"].map((node, i, arr) => (
                  <div key={node} className="flex items-center gap-1">
                    <span className="inline-flex items-center rounded-xs border border-teal-200 dark:border-teal-800 bg-teal-50 dark:bg-teal-950/50 px-2.5 py-1 text-[10px] font-medium text-teal-700 dark:text-teal-400">
                      {node}
                    </span>
                    {i < arr.length - 1 && (
                      <svg className="w-2.5 h-2.5 text-stone-300 dark:text-stone-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-6 lg:gap-8 items-start mb-20">
          ...
          <div className="hidden lg:flex items-center justify-center pt-10">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="w-8 h-8 rounded-full border border-teal-200 dark:border-teal-800 bg-teal-50 dark:bg-teal-950 flex items-center justify-center text-teal-600 dark:text-teal-400">
            ...
            <div className="rounded-lg border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 overflow-hidden">
              {[
                ...
                >
                  ...
                  <span className="text-[11px] font-semibold font-mono text-teal-500 dark:text-teal-400 flex-shrink-0 w-8 text-right">{conf}%</span>
                </div>
              ))}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Google Meet",  note: "Live bot via calendar",       dot: "bg-green-400"  },
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  { name: "Dashboard",   note: "Built-in review UI",          dot: "bg-teal-400"   },
                  { name: "JSON export", note: "Full structured record",       dot: "bg-teal-400"   },
                  { name: "CSV export",  note: "Flat file for spreadsheets",  dot: "bg-teal-400"   },
  ...
  return (
    ...
    >
      ...
      <div className="relative mkt-section">
        ...
        <div className="overflow-hidden mb-14">
          <h2
            className="font-display italic text-teal-400 leading-[0.96] select-none"
            style={{ fontSize: "clamp(3.2rem, 11vw, 10.5rem)" }}
          >
            <span className="block">Structure</span>
            <span className="block text-teal-700/80">is permanent.</span>
          </h2>
        </div>
    ...
    <section className="py-24 lg:py-32 bg-stone-50 dark:bg-stone-950">
      <div className="mkt-section">
          ...
          {plans.map((plan) => (
            <div
              ...
              className={[
                ...
                plan.highlight
                  ? "border-teal-300 dark:border-teal-700 bg-white dark:bg-stone-900 ring-1 ring-teal-200 dark:ring-teal-800/50"
              ...
              <ul className="space-y-2.5 flex-1 mb-7">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-start gap-2.5 text-sm text-stone-600 dark:text-stone-300">
                    <CheckIcon className={plan.highlight ? "text-teal-500" : "text-stone-400"} />
                    {f}
                  </li>
                ))}
              </ul>
        ...
        <p className="text-center mt-7 text-xs text-stone-400 dark:text-stone-500">
          ...
          <Link href="/pricing" className="text-teal-600 dark:text-teal-400 hover:underline underline-offset-2">
...
function CheckIcon({ className = "text-teal-500" }: { className?: string }) {
  return (
    <svg
