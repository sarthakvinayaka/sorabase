  ...
  return (
    <div
      className={[
        ...
        plan.primary
          ? "border-aubergine-300 dark:border-aubergine-900 bg-white dark:bg-stone-900 ring-1 ring-aubergine-200/60 dark:ring-aubergine-900/40"
    ...
    >
      ...
      <div
        className={[
          ...
          plan.primary
            ? "border-aubergine-100 dark:border-aubergine-950/60"
              ...
              <Fragment key={category}>
                ...
                {rows.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center bg-aubergine-50/20 dark:bg-aubergine-950/10">
  ...
  if (typeof value === "boolean") {
    return value ? (
      <span className="inline-flex items-center justify-center">
        <svg className="w-4 h-4 text-aubergine-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      <div className="grid lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-stone-100 dark:divide-stone-800">
        ...
        <div className="px-8 py-8 lg:px-10">
          <div className="flex items-center gap-2 mb-5">
            <span className="w-2 h-2 rounded-full bg-aubergine-700 flex-shrink-0" />
            <span className="text-[10px] font-semibold tracking-[0.12em] uppercase text-aubergine-800 dark:text-aubergine-400">
              Recruiter Mode
            </span>
          </div>
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={item} className="flex items-center gap-2.5 text-[13px] text-stone-600 dark:text-stone-300">
                <span className="w-1 h-1 rounded-full bg-aubergine-400 flex-shrink-0" />
                {item}
              </li>
            ))}
          </ul>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-center mt-10 text-xs text-stone-400 dark:text-stone-500">
        More questions?{" "}
        <a href="mailto:hello@sorabase.com" className="text-aubergine-800 dark:text-aubergine-400 hover:underline underline-offset-2">
          hello@sorabase.com
        </a>
      </p>
    </div>
...
function CheckIcon({ accent = false }: { accent?: boolean }) {
  return (
    <svg
      className={["w-[14px] h-[14px] flex-shrink-0 mt-0.5", accent ? "text-aubergine-700" : "text-stone-400"].join(" ")}
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      strokeWidth={2.5}
