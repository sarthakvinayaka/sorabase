      ...
      <div className="space-y-1.5">
        <label className="flex items-center gap-2 cursor-pointer text-stone-600 dark:text-stone-400">
          <input
            ...
            className="h-3 w-3 rounded text-aubergine-800"
          />
          Include AI summary
        </label>
        <label className="flex items-center gap-2 cursor-pointer text-stone-600 dark:text-stone-400">
        ...
        {endpoints.map((ep) => (
          ...
          >
            <span className={[
              ...
              ep.method === "GET"
                ? "bg-aubergine-100 dark:bg-aubergine-950/40 text-aubergine-900 dark:text-aubergine-400"
...
function CheckIcon() {
  return (
    <svg className="w-3.5 h-3.5 text-aubergine-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
