    ...
    <div className="space-y-3">
      ...
      {!isGenerating && isEditing && (
        <textarea
          ...
          disabled={isSaving}
          className="w-full min-h-[140px] rounded border border-teal-300 bg-white px-4 py-3 text-sm text-stone-800 leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-teal-400 disabled:opacity-50"
