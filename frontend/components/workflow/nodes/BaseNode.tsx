  ...
  return (
    <div
      className={[
        ...
        selected
          ? "border-teal-500 shadow-[0_0_0_2px_rgba(26,107,90,0.18)]"
      ...
      {!hideTarget && (
        <Handle
          ...
          className={[
            ...
            "group-hover:!border-teal-400 group-hover:!bg-teal-50 dark:group-hover:!bg-teal-900/30",
            "hover:!scale-125 hover:!border-teal-500 hover:!bg-teal-50",
