...
const TAG_VARIANT: Record<TagVariant, string> = {
  default: "tag-mkt",
  teal:    "inline-flex items-center rounded-full border border-teal-200 dark:border-teal-800 px-2.5 py-0.5 text-[11px] font-medium text-teal-700 dark:text-teal-400",
